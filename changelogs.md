...
- **The pal you clicked stays highlighted** — the first pal you picked lost its selection outline whenever the grid refreshed, and flickered every time you changed something, even though it was still selected and still being edited. The outline is now put back after every refresh, in the palbox, party, DPS storage and Global Pal Storage, so what looks selected really is selected.
